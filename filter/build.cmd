...
powershell -Command "[IO.File]::WriteAllText(\"src\abpvn_general.txt\",((Get-Content src\abpvn_general.tmp | Sort-Object | Get-Unique) -join \"`r`n\"));[IO.File]::WriteAllText(\"src\abpvn_elemhide.txt\",((Get-Content src\abpvn_elemhide.tmp | Sort-Object | Get-Unique) -join \"`r`n\"));[IO.File]::WriteAllText(\"src\abpvn_whitelist.txt\",((Get-Content src\abpvn_whitelist.tmp | Sort-Object | Get-Unique) -join \"`r`n\"));[IO.File]::WriteAllText(\"src\abpvn_whitelist_elemhide.txt\",((Get-Content src\abpvn_whitelist_elemhide.tmp | Sort-Object | Get-Unique) -join \"`r`n\"));[IO.File]::WriteAllText(\"src\abpvn_adult.txt\",((Get-Content src\abpvn_adult.tmp | Sort-Object | Get-Unique) -join \"`r`n\"));[IO.File]::WriteAllText(\"src\abpvn_adult_elemhide.txt\",((Get-Content src\abpvn_adult_elemhide.tmp | Sort-Object | Get-Unique) -join \"`r`n\"));"
