...
parser = argparse.ArgumentParser("Create checksum")
parser.add_argument('--input', '-i', help="Input file", type=str)
parser.add_argument('--output', '-o', help="output file", type=str, default='output.txt')
...
if __name__ == '__main__':    
    data = addChecksum(read_file(args.input))
